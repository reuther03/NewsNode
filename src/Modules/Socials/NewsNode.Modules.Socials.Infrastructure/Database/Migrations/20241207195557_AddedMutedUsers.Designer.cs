...
namespace NewsNode.Modules.Socials.Infrastructure.Database.Migrations
{
    ...
    [Migration("20241207195557_AddedMutedUsers")]
    partial class AddedMutedUsers
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("NewsNode.Modules.Socials.Domain.UserProfile.UserProfile", b =>
                {
                    ...
                    b.OwnsMany("NewsNode.Shared.Abstractions.Kernel.ValueObjects.Ids.UserId", "MutedUserProfileIds", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer");
                            ...
                            b1.ToTable("User_muted_profiles", "socials");
                    ...
                    b.Navigation("MutedUserProfileIds");
                });
